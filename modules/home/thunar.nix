...

{
  home = {
    ...
    file.".config/Thunar/accels.scm".text = ''
      ...
      ; (gtk_accel_path "<Actions>/ThunarBookmarks/63ef4db365e7cc260e87298c9fe576d6" "")
      ...
      ; (gtk_accel_path "<Actions>/ThunarBookmarks/5fba81fd54a37f2a417392dba36428ae" "")
      ...
      ; (gtk_accel_path "<Actions>/ThunarBookmarks/644cf038114529ed17b9320f75792cf3" "")
    ...
    file.".config/Thunar/uca.xml".text = ''
      ...
      <action>
      	...
      	<unique-id>1576171289233624-1</unique-id>
